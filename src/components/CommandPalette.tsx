  ...
  const commands = useMemo<PaletteCommand[]>(
    () => [
      ...
      },
      {
        ...
        detail: "Jump to the Graphite-style dependency map for stack lanes, blockers, drift, and AI gaps.",
        shortcut: "S1",
        keywords: "stack topology map dependency graph lanes blockers drift ai gaps graphite",
        tone: "blue",
        icon: Layers3,
      ...
      },
      {
        ...
        shortcut: "S",
        keywords: "stack navigator graphite bottom up stacked pr review order ci ai blockers",
        tone: "blue",
        icon: Workflow,
